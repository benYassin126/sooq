              ...
              <div class="header-button wow fadeInUp" data-wow-delay="0.3s">
                ...
                <div class="MocUp text-center" id='inst'>
                  ...
                  <div class="screen">
                    ...
                    @forelse($allImgPath as $key => $img)
                    <img class="imgesInMockUp" src="/img/output/[{{$key + 1}}]__{{$img - 300 }}.png">
                    @empty
                    {{'pre'}}
                    @endforelse
                </div>
...
<div class="col-md-6 col-sm-6">
    <div class=" text-center">
        ...
        <button class="btn btn-dark">غير الشكل</button>
        @endif

        @if( session()->get('CountOfTry') > 1)
        <hr>
        <img style="width: 77px;height: 70px;" src="/img/face2.gif">
        <button class="btn btn-primary">الشكل الآخر</button>
        @endif
     </div>
</div>
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary">تجربة جديدة</button>
</div>
</div>
</div>
</div>
