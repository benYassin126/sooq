                ...
                <div class="row">
                  <div class="card card-info  mb-4">
                    <div class="card-header">
                      <ul>
                        <li>عشان يطلع التصميم مظبوط صح .. عطني بعض تفاصيل نشاطك  الله يسعدك :)</li>
                      </ul>
                    </div>
                    <form id="ColorsForm"class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          <label class="control-label">لون الهوية الأساسي  (Hex) </label><span style="color:black;font-size: 14px;"> كل ما اخترت الوانك بشكل صحيح .. كلما كان التصميم رهيب </span>
                          <div>
                        ...
                        <p>عطني لاهنت أي حساب من حسابات نشاطك على وسائل التواصل الإجتماعي</p><span id="alert" style="display: none;" class="right badge badge-danger">لاهنت على الاقل عطني حساب واحد</span>
                        <div class="form-group">
