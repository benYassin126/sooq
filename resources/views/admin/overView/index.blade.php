     ...
     <h4 class="text-center mb-4">اختبار A/B Testing</h4>
      ...
      <table class="table  table-bordered table-striped">
        ...
        <tbody>
          <tr>
            <td>1</td>
            <td>عدد اللي جاهم نموذج  A</td>
            <td>{{$ABefore}}</td>
          </tr>
          <tr>
            <td>2</td>
            <td>عدد اللي جاهم نموذج  B</td>
            <td>{{$BBefore}}</td>
          </tr>
          <tr>
            <td>3</td>
            <td>عدد اللي عرفوا انها قوالب وكملوا</td>
            <td>{{$BAfter}}</td>
          </tr>
          <tr>
            <td>4</td>
            <td>نسبة اللي عرفوا انها قوالب وكملوا</td>
            <td>{{$PrB}}%</td>
          </tr>
          <tr>
            <td>5</td>
            <td>نسبة اللي جاهم نموذج A وكملوا للاخير</td>
            <td>{{$PrAComplate}}%</td>
          </tr>
          <tr>
            <td>6</td>
            <td>نسبة اللي جاهم نموذج  B وكملوا للاخير</td>
            <td>{{$PrBComplate}}%</td>
          </tr>
        </tbody>
        <tfoot>
